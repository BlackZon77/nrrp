...
Config.Weapons = {
	{
		...
		components = {
			...
			{ name = 'scope_macro', label = _U('component_scope_macro'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_02_SMG_MK2') },
			{ name = 'scope_small', label = _U('component_scope_small'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL_SMG_MK2') },
	...
	
	{
		...
		components = {
			...
			{ name = 'scope_macro', label = _U('component_scope_macro'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_02_MK2') },
			{ name = 'scope_small', label = _U('component_scope_small'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL_MK2') },
	...
	
	{
		...
		components = {
			...
			{ name = 'scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SIGHTS') },
			{ name = 'scope_macro', label = _U('component_scope_macro'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_MK2') },
			{ name = 'scope_medium', label = _U('component_scope_medium'), hash = GetHashKey('COMPONENT_AT_SCOPE_MEDIUM_MK2') },
	...
	
	{
		...
		components = {
			...
			{ name = 'scope_large', label = _U('component_scope_medium'), hash = GetHashKey('COMPONENT_AT_SCOPE_LARGE_MK2') },
	...
	
	{
		...
		components = {	
			...
			{ name = 'scope_mounted', label = _U('component_scope_mounted'), hash = GetHashKey('COMPONENT_AT_PI_RAIL') },
