...
ESX.RegisterUsableItem('absinto', function(source)

	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeInventoryItem('absinto', 1)

	TriggerClientEvent('esx_status:add', source, 'drunk', 125000)
	TriggerClientEvent('esx_optionalneeds:onDrink', source)
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = _U('used_absinto'), length = 3000})
