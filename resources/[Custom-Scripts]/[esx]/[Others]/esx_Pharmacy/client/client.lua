...
local store = {    
    [_U('open_store')] = { title="FarmaciaHospital", size= 10, colour=34, id=51, x = -489.38, y = -340.4, z = 41.32,},
	[_U('open_store2')] = { title="FarmaciaPalleto", size= 10, colour=34, id=51, x =  -254.21, y =6334.64, z = 31.43,},	
}  


local NPC = { 
    {seller = true, model = "s_m_m_doctor_01", x = -489.42, y = -341.52, z = 41.32, h = 349.337},
	{seller = true, model = "s_m_m_doctor_01", x = -254.2, y =6335.71, z = 31.43, h = 163.36 },
}
        ...
        'default', GetCurrentResourceName(), 'Pharmacy_markets',
         {
            ...
            elements = {
				{label = ('Medikit - <span style="color:green;">2500$</span>'), item = 'medikit', price = 2500, amount = 1},
				{label = ('bandage - <span style="color:green;">1500$</span>'), item = 'bandage', price = 1500, amount = 1},
