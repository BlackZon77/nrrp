Locales['br'] = {
  ...
  ['tirarcolete_wear'] = 'Tirar Colete',
  ['colete_wear'] = 'Colete Balistico',
  ['coleter1_wear'] = 'Colete Refletor',
  ...
  -- Armory
  ['remove_object'] = 'Retirar pertence',
  ['deposit_object'] = 'Depositar Pertences',
  ...
  ['armory_componenttitle'] = 'Arsenal - Opções Armas',
  ...
  ['get_weapon_menu'] = 'Arsenal - Retirar Armas',
  ['put_weapon_menu'] = 'Arsenal - Guardar Armas',
  -- Vehicles
  ['vehicle_menu'] = 'Viaturas',
  ['vehicle_blocked'] = 'Todos os locais de spawn estão ocupados!',
  ['garage_prompt'] = 'Clica ~INPUT_CONTEXT~ para ter abrir o  ~y~Menu das Viaturas~s~.',
  ['garage_title'] = 'Ações das Viaturas',
  ...
  ['garage_storeitem'] = 'Guardar Viatura na garagem',
  ['garage_buyitem'] = 'Comprar Viatura',
