...
function setUniform(uniform, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		...
		if uniformObject then
			...
			ESX.ShowNotification('Sem Farda')
		end
	end)
end
...
function OpenCloakroomMenu()
	...
	local elements = {
		{label = 'Roupa Normal', value = 'citizen_wear'},
		{label = '------------------', uniform = 'ttt_wear'},
		{label = 'Chapéu INEM', uniform = 'chapeuinem'},
		{label = 'Capacete Mota INEM', uniform = 'motainem'},
		{label = 'Capacete Heli INEM', uniform = 'heliinem'},
		{label = '------------------', uniform = 'ttt_wear'},
		{label = 'Farda Mota INEM', uniform = 'mota'},
		{label = 'Farda Hoodie INEM', uniform = 'hoodie'},
		{label = '------------------', uniform = 'ttt_wear'}
	}
	
	if grade == 'ambulance' then
		table.insert(elements, {label = 'Farda TEPH', uniform = 'teph'})
		table.insert(elements, {label = 'Farda Casaco TEPH', uniform = 'tephcasaco'})
	elseif grade == 'doctor' then
		table.insert(elements, {label = 'Farda Enfermeiro/a', uniform = 'enfer'})
		table.insert(elements, {label = 'Farda Casaco Enfermeiro', uniform = 'enfercasaco'})
	elseif grade == 'chief_doctor' then
		table.insert(elements, {label = 'Farda Médico/a', uniform = 'medico'})
		table.insert(elements, {label = 'Farda Casaco Médico', uniform = 'medicocasaco'})
	elseif grade == 'medc' then
		table.insert(elements, {label = 'Farda Médico/a Chefe', uniform = 'medico'})
		table.insert(elements, {label = 'Farda Casaco Médico', uniform = 'medicocasaco'})
	elseif grade == 'subdiret' then
		table.insert(elements, {label = 'Farda Sub-Diretor/a | Delegado/a Regional', uniform = 'dele'})
		table.insert(elements, {label = 'Farda Casaco Sub-Diretor/a | Delegado/a Regional', uniform = 'delecasaco'})
	elseif grade == 'boss' then
		table.insert(elements, {label = 'Farda Diretor/a | Delegado/a Regional', uniform = 'dele'})
		table.insert(elements, {label = 'Farda Casaco Diretor/a | Delegado/a Regional', uniform = 'delecasaco'})
