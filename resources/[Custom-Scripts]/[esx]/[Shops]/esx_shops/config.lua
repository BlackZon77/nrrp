Config = {
    ...
    Locations = {
        ...
        [21] = {
            ["shelfs"] = {
                {["x"] = -1192.36, ["y"] = -895.2, ["z"] = 14.0, ["value"] = "macpatos"},
                {["x"] = -1194.01, ["y"] = -892.78, ["z"] = 14.2, ["value"] = "checkout"},
            },
            ["blip"] = {
                ["x"] = -1194.01, ["y"] = -892.78, ["z"] = 14.2
            },
            ["cashier"] = {
                ["x"] = -1195.29, ["y"] = -893.82, ["z"] = 13.0, ["h"] = 305.4
            },
        },
    },
    ...
    Items = {
        ["macpatos"] = {
            {label = "Hamburger", item = "hamburger", price = 10},
            {label = "Batatas Fritas", item = "chips", price = 5},
            {label = "Fanta", item = "fanta", price = 5},
            {label = "Cocacola", item = "cocacola", price = 5},
            {label = "Água", item = "water", price = 3},
        },
        ["drinks"] = {
        ...
        ["snacks"] = {
            {label = "Café", item = "coffe", price = 3},
            {label = "Batatas Fritas", item = "chips", price = 5},
            {label = "Pão", item = "bread", price = 2},
        },
        ["readymeal"] = {
        ...
        ["diverse"] = {
            ...
            {label = "Cartão SIM", item = "sim", price = 50},
            {label = "Rádio", item = "radio", price = 250},
            {label = "Sacos", item = "drugbags", price = 50},
            {label = "Isqueiro", item = "lighter", price = 5},
            {label = "Cigarro", item = "cigarett", price = 10},
            {label = "Telemovel", item = "phone", price = 800}
        },
    },
}