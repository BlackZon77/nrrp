...
Config.BlipZones = { 
   ...
   {title="Alugar Bicicleta", colour=2, id=376, x = -248.938, y = -339.955, z = 29.969},
   {title="Alugar Bicicleta", colour=2, id=376, x = -6.892, y = -1081.734, z = 26.829},
   {title="Alugar Bicicleta", colour=2, id=376, x = -1262.36, y = -1438.98, z = 3.45},
   {title="Alugar Bicicleta", colour=2, id=376, x = 181.53,y = -771.91,z = 47.08},
}
