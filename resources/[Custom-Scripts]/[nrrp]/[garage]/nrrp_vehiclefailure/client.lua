...
RegisterNetEvent('nrrp_vehiclefailure:repair')
AddEventHandler('nrrp_vehiclefailure:repair', function()
...
RegisterNetEvent('nrrp_vehiclefailure:notAllowed')
AddEventHandler('nrrp_vehiclefailure:notAllowed', function()
...
disableSeatShuffle = function(flag) disableShuffle = flag end
