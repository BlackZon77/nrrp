...
(() => {
    ...
    NRRPHud.Close = function() {

    };

    NRRPHud.Show = function(data) {
        if(data.type == "cash") {
    ...
    NRRPHud.ToggleSeatbelt = function(data) {
        if (data.seatbelt) {
    ...
    NRRPHud.UpdateHud = function(data) {
        var Show = "block";
        if (data.show) {
            Show = "none";
    ...
    NRRPHud.Update = function(data) {
        if(data.type == "cash") {
            $(".money-cash").css("display", "block");
            $("#cash").html(data.cash);
            if (data.minus) {
                $(".money-cash").append('<p class="moneyupdate minus">-<span><span id="minus-changeamount">' + data.amount + '</span><span id="cash-symbol">&euro;&nbsp;</span></span></p>')
                ...
                $(".money-cash").append('<p class="moneyupdate plus">+<span><span id="plus-changeamount">' + data.amount + '</span><span id="cash-symbol">&euro;&nbsp;</span></span></p>')
    ...
    NRRPHud.UpdateCompass = function(data) {
    ...
    NRRPHud.UpdateMeters = function(data) {
    ...
    window.onload = function(e) {
        window.addEventListener('message', function(event) {
            switch(event.data.action) {
                case "open":
                    NRRPHud.Open(event.data);
                    break;
                case "close":
                    NRRPHud.Close();
                    break;
                case "update":
                    NRRPHud.Update(event.data);
                    break;
                case "show":
                    NRRPHud.Show(event.data);
                    break;
                case "hudtick":
                    NRRPHud.UpdateHud(event.data);
                    break;
                case "car":
                    NRRPHud.CarHud(event.data);
                    break;
                case "seatbelt":
                    NRRPHud.ToggleSeatbelt(event.data);
                    break;
                case "UpdateCompass":
                    NRRPHud.UpdateCompass(event.data);
                    break;
                case "UpdateDrivingMeters":
                    NRRPHud.UpdateMeters(event.data);
                    break;
