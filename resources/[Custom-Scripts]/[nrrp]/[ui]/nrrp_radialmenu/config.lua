...
rootMenuConfig =  {
    {
        ...
        -- subMenus = {"general:flipvehicle",  "general:ccdar", "general:ccver",  "general:sellcar",  "general:emotes", "general:openphone", "general:opensim", "general:searchinv" }
        subMenus = {"general:flipvehicle",  "general:ccdar", "general:ccver",  "general:sellcar",  "general:emotes", "general:openphone", "general:searchinv" }
    },
    {
        id = "police-action",
        ...
        subMenus = { "police:handcuff", "police:putinvehicle", "police:unseatnearest", "police:openmdt", "police:getid", "police:searchinv", "police:seebills","police:checklicenses", "police:arrastar" }
    },
    {
        id = "mechanic-action",
        displayName = "Ações de Mecanico",
        icon = "#police-action",
        enableMenu = function()
            local ped = PlayerPedId()
            PlayerData = ESX.GetPlayerData()
        ...
        subMenus = { "mech:bills", "mech:cleanvehicle", "mech:repairveh", "mech:removeveh", "mech:ferramentas", "mech:trolley", "mech:cone"}
    },
    {
        id = "animations",
...
newSubMenus = {
    ...
    ['mech:repairveh'] = {
        title = "Reparar Carro",
        icon = "#mech-repair",
        functionName = "mech:repairveh"
    },
    ['mech:removeveh'] = {
        title = "Remover Carro",
        icon = "#mech-removeveh",
        functionName = "mech:removeveh"
    },
    ['mech:ferramentas'] = {
        title = "Ferramentas",
        icon = "#mech-tools",
        functionName = "mech:ferramentas"
    },
    ['mech:trolley'] = {
        title = "Trolley",
        icon = "#mech-trolley",
        functionName = "mech:trolley"
    },
    ['mech:cone'] = {
        title = "Cone",
        icon = "#mech-cone",
        functionName = "mech:cone"
    },
