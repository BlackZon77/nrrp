...
RegisterNetEvent("nrrp_serversync:updateFromServerTime")
AddEventHandler("nrrp_serversync:updateFromServerTime", function(serverSecondOfDay,serverDate,isTimeFrozen)
    frozen = isTimeFrozen
