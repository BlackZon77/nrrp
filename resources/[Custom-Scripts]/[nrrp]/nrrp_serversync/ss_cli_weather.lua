...
AddEventHandler( "onClientMapStart", function()
    ...
    TriggerServerEvent( "nrrp_serversync:changeWeather",true )
end)

RegisterNetEvent("nrrp_serversync:changeWeather")
AddEventHandler("nrrp_serversync:changeWeather", function(newWeather,blackout,startup)
