...
Config.ItemDrops  = {
   { name = 'diamondbox', max = 1,  chance = 6 },
   { name = 'goldbar', max = 1, chance = 24 },
   { name = 'rolex', max = 1,  chance = 54},
   { name = 'wedding_ring', max = 2,  chance = 42},
   { name = 'necklace', max = 4, chance = 60 },
   { name = 'earrings', max = 3, chance = 90 },
}
