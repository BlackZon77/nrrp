...
Config.AlertInChatMessage = "'ÚLTIMAS NOTÍCIAS' ^7 Roubo em progresso a ^1"


Config.Trolley = {
    ["cash"] = { 450, 700 }, -- this is what you receive every cash stack math.random(1, 2)
