function SaveToDatabase()
    TriggerServerEvent("nrrp_warehouse:insertWH", Warehouse)
end
            ...
            ESX.UI.Menu.Open("default", GetCurrentResourceName(), "buy_menu", {
                ...
                if action == "s1_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s1_1, action)
                ...
                elseif action == "s1_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s1_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s2_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s2_1, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s2_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s2_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s3_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s3_1, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s3_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s3_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s4_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s4_1, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s4_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s4_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s5_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s5_1, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s5_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s5_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s6_1" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s6_1, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
                ...
                elseif action == "s6_2" then
                    if CheckStatus(action) then
                        TriggerServerEvent("nrrp_warehouse:checkMoney", Config.Price.s6_2, action)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
                        exports['mythic_notify']:SendAlert("error", _U("already_have"))
        ...
        elseif data.current.value == "sell_menu" then
            ...
            ESX.UI.Menu.Open("default", GetCurrentResourceName(), "sell_menu", {
                ...
                elseif action == "sell" then
                    if count >= 1 then
                        TriggerEvent("nrrp_warehouse:sell", count, worth)
                        TaskPlayAnim(ped, "anim@amb@warehouse@laptop@", "exit", 8.0, 8.0, 0.1, 0, 1, false, false, false)
                        ESX.UI.Menu.CloseAll()
                    else
...
function SpawnEnemyNPC(x, y, z, target) -- Works decent but not exactly how I want, still working no improving it
    ...
    if done and HasModelLoaded(0x964D12DC) and HasModelLoaded(0x132D5A1A) then
        ...
        GiveWeaponToPed(Driver, "WEAPON_MICROSMG", 400, false, true)    GiveWeaponToPed(Passenger, "WEAPON_MICROSMG", 400, false, false)
        ...
        SetPedFleeAttributes(Driver, 0, false)                          SetPedFleeAttributes(Passenger, 0, false)
