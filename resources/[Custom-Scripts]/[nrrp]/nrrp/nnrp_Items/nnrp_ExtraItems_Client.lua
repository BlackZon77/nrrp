...
-- Activate binoculars
RegisterNetEvent('NRRPEI:binoculars:Activate')
AddEventHandler('NRRPEI:binoculars:Activate', function()
...
RegisterNetEvent('nrrp:cigarett:startSmoke')
AddEventHandler('nrrp:cigarett:startSmoke', function(source) SmokeAnimation() end)

function SmokeAnimation()
	local playerPed = GetPlayerPed(-1)
	Citizen.CreateThread(function() TaskStartScenarioInPlace(playerPed, "WORLD_HUMAN_SMOKING", 0, true) end)
end


Citizen.CreateThread(function(...) NRRPEI:Start(...); end)
