...
Config.Zones = {
   PinkCage = {
      ...
      Pos = {x = 324.55, y = -212.44, z = 54.15, color = 23, sprite = 475, size = 0.7},
   ...
   ForumDrive = {  
      Name = "Paleto Motel ",
      Pos = {x = -686.12, y = 5770.2, z = 17.3, color = 15, sprite = 475, size = 0.7},
      roomExit = {x = 151.25, y = -1007.74, z = -99.00}, -- The Exit marker of the room, usually the only door hehe
      roomLoc = {x = 151.25, y = -1007.74, z = -99.00}, -- Where you will spawn IN the motel room
      BedStash = {x = 154.47, y = -1005.92, z = -99.0},  -- The Secret Stash Location of the Bed
      Inventory = {x = 151.83, y = -1001.32, z = -99.00},  -- The Inventory of the Room Main Storage
      ...
      Rooms = {
         Room1 = {
               number = 1,
               instancename = "fdm1",
               entry = {x = -682.08,  y =  5770.81,  z = 17.51},
         },
         Room2 = {
               number = 2,
               instancename = "fdm2",
               entry = {x = -683.81,  y = 5766.73,  z = 17.51},
         },  
         Room3 = {
            number = 3,
            instancename = "fdm3",
            entry = {x = -685.56,  y = 5762.98,  z = 17.51},
         },  
         Room4 = {
            number = 4,
            instancename = "fdm4",
            entry = {x = -687.44,  y = 5758.87,  z = 17.51,},
         },  
         Room5 = {
            number = 5,
            instancename = "fdm5",
            entry = {x =  -690.23,  y = 5759.51,  z = 17.51,},
         },  
         Room6 = {
            number = 6,
            instancename = "fdm6",
            entry = {x = -694.35,  y = 5761.43,  z = 17.51},
         },
         Room7 = {
            number = 7,
            instancename = "fdm7",
            entry = {x = -698.21,  y = 5763.19,  z = 17.51,},
         },  
         Room8 = {
            number = 8,
            instancename = "fdm8",
            entry = {x = -702.12,  y = 5764.98,  z = 17.51},
         },
         Room9 = {
            number = 9,
            instancename = "fdm9",
            entry = {x = -706.07,  y = 5766.89,  z = 17.51,},
         },          
         Room10 = {
            number = 10,
            instancename = "fdm9",
            entry = {x = -709.88,  y = 5768.69,  z = 17.51,},
