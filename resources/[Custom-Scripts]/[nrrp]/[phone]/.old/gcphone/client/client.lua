...
Citizen.CreateThread(function()
  while true do
    ...
    if takePhoto ~= true then
      ...
      -- elseif IsControlJustPressed(1, KeySimMenu) then
      --   hasPhone(function (hasPhone)
      --     if hasPhone == true then
...
AddEventHandler('general:openphone', function() hasPhone(function (hasPhone) if hasPhone == true then TooglePhone() else ShowNoPhoneWarning() end end) end)
--====================================================================================
...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
   ...
   exports["mumble-voip"]:SetCallChannel(infoCall.id + 1200)
  end
  if menuIsOpen == false then 
    TooglePhone()
  end
