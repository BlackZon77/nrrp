				...
				if amount ~= nil then
					if xPlayer.getAccount('bank').money >= amount then	
						MySQL.Async.execute('DELETE from billing WHERE id = @id', {
							...
							TriggerClientEvent("esx:showNotification", src, "A fatura de" .. amount .. " € foi paga")
							TriggerClientEvent("esx:showNotification", sender, "Não tens dinheiro suficiente.")
							TriggerClientEvent("esx:showNotification", xTarget.source, "A fatura de" .. amount .. " € foi paga")
						end)
					else
						TriggerClientEvent("esx:showNotification", sender, "Não tens dinheiro suficiente.")
						TriggerClientEvent("esx:showNotification", src, "A fatura de" .. amount .. " € foi paga")
