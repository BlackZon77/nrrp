...
RegisterNetEvent('nrrp_props:attachProp')
AddEventHandler('nrrp_props:attachProp', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
...
function attach(prop)
    TriggerEvent("nrrp_props:attachItem",prop)
end
...
RegisterNetEvent('nrrp_props:attachItem')
AddEventHandler('nrrp_props:attachItem', function(item)
	for i=1 ,#attachPropList , 1 do
		if (attachPropList[i].model == item) then
			TriggerEvent("nrrp_props:attachProp",attachPropList[i].model, attachPropList[i].bone, attachPropList[i].x, attachPropList[i].y, attachPropList[i].z, attachPropList[i].xR, attachPropList[i].yR, attachPropList[i].zR)
		end
	end
end)
