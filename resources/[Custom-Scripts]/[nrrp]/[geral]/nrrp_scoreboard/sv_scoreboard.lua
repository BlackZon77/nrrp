...
RegisterServerEvent('nrrp_scoreboard:AddPlayer')
AddEventHandler("nrrp_scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("nrrp_scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("nrrp_scoreboard:AddAllPlayers", source, data, recentData)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("nrrp_scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("nrrp_scoreboard:RemoveRecent", -1, plyid)
end)
