...
RegisterServerEvent("nrrp_pawnshop:BuyItem")
AddEventHandler("nrrp_pawnshop:BuyItem", function(amountToBuy,totalBuyPrice,itemName)
...
RegisterServerEvent("nrrp_pawnshop:SellItem")
AddEventHandler("nrrp_pawnshop:SellItem", function(amountToSell,totalSellPrice,itemName)
	local xPlayer = ESX.GetPlayerFromId(source)
	local itemLabel = ESX.GetItemLabel(itemName)
