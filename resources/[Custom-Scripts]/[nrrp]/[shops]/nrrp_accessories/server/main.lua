...
RegisterServerEvent('nrrp_accessories:pay')
AddEventHandler('nrrp_accessories:pay', function()
...
RegisterServerEvent('nrrp_accessories:save')
AddEventHandler('nrrp_accessories:save', function(skin, accessory)
...
ESX.RegisterServerCallback('nrrp_accessories:get', function(source, cb, accessory)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('nrrp_accessories:checkMoney', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
