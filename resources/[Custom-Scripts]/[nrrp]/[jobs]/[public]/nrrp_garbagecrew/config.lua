...
Config.BagPay = 40 -- The amount paid to each person per bag
Config.StopPay = 5 -- Total pay for the stop before bagpay.
...
Config.VehicleSpawn = {pos = vector3(2763.09, 1377.82, 24.52),}

Config.Zones = {
	[1] = {type = 'Zone', size = 5.0 , name = 'endmission', pos = vector3(2781.25, 1474.3, 24.53)},
	[2] = {type = 'Zone', size = 3.0 , name = 'timeclock', pos = vector3(2744.3, 1487.54, 30.79)},
	[3] = {type = 'Zone', size = 3.0 , name = 'vehiclelist', pos = vector3(2767.88, 1392.89, 24.54)},
}
