...
RegisterServerEvent('nrrp_poolcleaner:GiveItem')
AddEventHandler('nrrp_poolcleaner:GiveItem', function()
...
RegisterServerEvent('nrrp_poolcleaner:startSale')
AddEventHandler('nrrp_poolcleaner:startSale', function()
...
RegisterServerEvent('nrrp_poolcleaner:stopSale')
AddEventHandler('nrrp_poolcleaner:stopSale', function()
