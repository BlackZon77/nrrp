                ...
                if DoesEntityExist(v) then
                    if GetDistanceBetweenCoords(GetEntityCoords(me), GetOffsetFromEntityInWorldCoords(v, 0.0, 2.0, 0.0), true) <= 1.5 then 
                        ...
                        if IsControlJustReleased(0, 38) or IsDisabledControlJustReleased(0, 38) then
                            TriggerServerEvent('nnrp_hbeds:gethelp', k)
                        end
                    end
                end
            end
...
RegisterNetEvent('nnrp_hbeds:revive')
AddEventHandler('nnrp_hbeds:revive', function(hospital)
    Cinema = true
...
RegisterNetEvent('nnrp_hbeds:notify')
AddEventHandler('nnrp_hbeds:notify', function(txt)
