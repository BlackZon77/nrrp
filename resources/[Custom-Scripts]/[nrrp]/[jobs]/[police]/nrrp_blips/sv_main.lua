local emstable = {}
local isCop = false
local _blip = "INDEFINIDO"
ESX         = nil

TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)

RegisterCommand('identificativo', function(source, args)
...
RegisterCommand('blipOFF', function(source, args)
...
RegisterCommand('blipON', function(source, args)
