Locales['br'] = {
  ...
  ['thelostmc_wear'] = 'Uniforme da Polícia',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~thelostmc~s~',
  -- Vehicle interaction
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['thelostmc_stock'] = 'thelostmc Stock',
  -- Misc
  ...
  -- Notifications
  ['alert_thelostmc'] = 'Alerta da thelostmc',
  ['phone_thelostmc'] = 'thelostmc',
}