...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = _U('thelostmc_wear'), uniform = grade}
	}
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_thelostmcjob:getOtherPlayerData', function(playerData)
...
AddEventHandler('esx_thelostmcjob:updateBlip', function()
	...
	if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'thelostmc' then
...
ClearAreaOfPeds(981.35, -113.31, 74.14, 100, 1)