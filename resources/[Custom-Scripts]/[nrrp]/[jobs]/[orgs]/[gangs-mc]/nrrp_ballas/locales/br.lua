Locales['br'] = {
  ...
  ['garage_storing'] = 'Estamos a tentar guardar carro, certifica te que n�o ha veiculos por perto.',
  ...
  ['garage_released'] = 'Seu veiculo foi retirado.',
  ['garage_store_nearby'] = 'there is no nearby vehicles.',
  ['garage_storeditem'] = 'Abir Garagem',
  ['garage_storeitem'] = 'Guardar veiculo na garagem',
  ['garage_buyitem'] = 'Stand de carros',
  ...
  ['have_withdrawn'] = 'Tu levantas-te ~y~%sx~s~ ~b~%s~s~',
  ['have_deposited'] = 'Tu depositas-te ~y~%sx~s~ ~b~%s~s~',
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
