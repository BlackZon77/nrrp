Locales['br'] = {
  ...
  ['garage_has_stored'] = 'Veiculo guardado na garagem',
  ...
  ['garage_released'] = 'Seu veiculo foi retirado fora da garagem.',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~uvanilla~s~',
  -- Vehicle interaction
  ...
  -- Notifications
  ['alert_uvanilla'] = 'Alerta da uvanilla',
  ['phone_uvanilla'] = 'uvanilla',
}