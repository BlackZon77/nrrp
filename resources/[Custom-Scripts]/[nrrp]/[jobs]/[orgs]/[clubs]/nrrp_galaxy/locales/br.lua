Locales['br'] = {
  ...
  ['galaxy_wear'] = 'Uniforme da Polícia',
  ...
  ['garage_storing'] = 'Esatmos a tentar guardar o veiculo, certifica te que nao ha players.',
  ['garage_has_stored'] = 'Veiculo foi guardado na garagem',
  ['garage_has_notstored'] = 'no nearby owned vehicles were found',
  ['garage_notavailable'] = 'Teu veiculo nao foi guardado na garagem.',
  ['garage_blocked'] = 'N�o ha spawn possivel!',
  ['garage_empty'] = 'N�o tens veiculos na garagem.',
  ...
  ['vehicleshop_money'] = 'N�o tens dinheiro para esse veiculo',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~galaxy~s~',
  -- Vehicle interaction
