...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local shopCoords = Config.TQLLStations[station][part][partNum].InsideShop
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('esx_tequilalajob:retrieveJobVehicles', function(jobVehicles)
							...
							if data2.current.stored then
								...
								if foundSpawn then
									...
									ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
										...
										TriggerServerEvent('esx_tequilalajob:setJobVehicleState', data2.current.plate, false)
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_tequilalajob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.TQLLStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_tequilalajob:buyJobVehicle', function (bought)
					if bought then
